...
let number9= (Math.floor(Math.random()*(30-9+1)+9)) ;
let number10= (Math.floor(Math.random()*(19-5+1)+5)) ;
document.getElementById("Vertaa ja Merkitse <tai>").innerHTML = "Vertaa ja Merkitse kumppi on isoin: "+" "+number9+" "+"or"+" "+number10;
...
// 10 > 12 
    if ((number9 > number10)){
        if(number9==jus5 ){
            ...
            document.getElementById("result5").innerHTML = ("Väärin!"+" "+"Oikea vastaus on"+" "+number9);
        } 
        ...
        if(number10==jus5 ){
            ...
            document.getElementById("result5").innerHTML =("Väärin!"+" "+"Oikea vastaus on"+" "+number10);
        } 
...
function anikapraveen() { 
    ...
    resultnum4()
    resultnum5()
    document.getElementById("anikaP").innerHTML=count;
}
